...
class SetupScreenState extends State<SetupScreen> {
  ...
  void _createUser() async {
    ...
    final bool success =
        await _userService.createUser(_usernameController.text);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text(AppLocalizations.of(context)!
                .serverConnectionError(dotenv.env['BASE_URL']!))),
      );
    }
  }
                  ...
                  child: PageView(
                    ...
                    children: [
                      ...
                      _buildFeaturePage(
                        ...
                        features: [
                          AppLocalizations.of(context)!.featureNoSignup,
                          AppLocalizations.of(context)!.featureTempCodes,
                          AppLocalizations.of(context)!.featureQuickMessages,
                          AppLocalizations.of(context)!.featurePrivacy,
                        ],
                      ),
                      _buildFeaturePage(
                        ...
                        features: [
                          AppLocalizations.of(context)!.useCaseArrival,
                          AppLocalizations.of(context)!.useCaseGaming,
                          AppLocalizations.of(context)!.useCaseSimpleHello,
                        ],
                      ),
                      _buildFinalPage(),
                    ],
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            AppLocalizations.of(context)!.welcomeToPlop,
      ...
      child: Column(
        children: [
                ...
                TextButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const ImportAccountScreen()));
                  },
          ...
          TextButton(
            onPressed: () async {
              final url = Uri.parse(
                  'https://www.buymeacoffee.com/antoineo'); // URL de don à remplacer
